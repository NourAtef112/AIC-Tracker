...
def build_tracker(checkpoint_path: str, config_path: str) -> OSTrack:
...
def run_sequence(tracker: OSTrack, seq_info, frames_root: Path) -> list:
...
def main():
    parser = argparse.ArgumentParser(description='OSTrack baseline inference — MTC-AIC4 Day 1')
    ...
    tracker = build_tracker(args.checkpoint, args.config)
